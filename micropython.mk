...
#     audiomath (Multiply), audioecho (FeedbackDelay), audioladder (Ladder)
#     and audioconvolve (Convolver) ---
#
...
# loop, audioladder puts four one-poles and a saturator inside a filter's,
# and audioconvolve applies a measured impulse response rather than imitating
# one. See docs/upstream-diff.md.
SRC_USERMOD_C += \

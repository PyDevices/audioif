...
#     audiomath (Multiply, SubOctave), audioecho (FeedbackDelay) and
#     audioconvolve
#     (Convolver) ---
#
...
# audioecho puts a filter inside a delay's feedback loop, and audioconvolve
# applies a measured impulse response rather than imitating one. See

// Ported from CircuitPython's shared-module/audiofilters/__init__.h
// (upstream repo: https://github.com/adafruit/circuitpython, MIT).
// Extracted from this port's Filter.c so Echo and Freeverb share one
// chain rather than a second copy of the same arithmetic.
//

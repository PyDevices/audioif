#!/usr/bin/env python3
"""audiodynamics, audioroute, audiomath, audioecho, audioladder and
audioconvolve parity: what the originals rendered, and what the ports render
now.
...
older to hold them to. `audiomath`, `audioecho`, `audioladder` and
...
disagreement between two builds would not stay one ulp; the ladder's loop is

...
audioif's own modules, with no ancestor in CircuitPython or in the engine;
...
route_probe.py; and neither has `Dynamics`' lookahead and true-peak options --
...
def capture(args):
    ...
    fixture = {
        ...
        "no_oracle": "audiomath, audioecho, audioconvolve and "
